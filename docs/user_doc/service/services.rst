...
2. Detailed options
    ...
    - *Command Class* : Parser Class : dedicated for specific and very complex command, set the :ref:`waves.commands` class implementation to create a job command line
