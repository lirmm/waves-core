...
latex_documents = [
    ('index', 'ReadtheDocsTemplate.tex', u'WAVES Documentation',
...
man_pages = [
    ('index', 'readthedocstemplate', u'WAVES Man page Documentation',
     [u'WAVES'], 1)
]
...
texinfo_documents = [
    ('index', 'ReadtheDocsTemplate', u'WAVES Documentation',
     u'WAVES', 'ReadtheDocsTemplate', 'One line description of project.',
     'Miscellaneous'),
]
