    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('restricted_client', models.ManyToManyField(blank=True, help_text='By default access is granted to everyone, you may restrict access here.', related_name='restricted_services', to=settings.AUTH_USER_MODEL, verbose_name='Restricted clients')),
            ],
            options={
