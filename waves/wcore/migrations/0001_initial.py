# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2017-10-02 12:35
...
import waves.wcore.models.inputs
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('api_name', models.CharField(blank=True, help_text='Api short code, must be unique, leave blank for automatic setup', max_length=100, null=True)),
                ('availability', models.IntegerField(choices=[(0, 'Not Available'), (1, 'Available web only'), (2, 'Available api only'), (3, 'Available api and web')], default=3, verbose_name='Availability')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cmd_format', models.IntegerField(choices=[(0, '-- Not used in job command line--'), (6, 'Named parameter: [name]=value'), (2, 'Named parameter: -[name] value'), (1, 'Named parameter: --[name]=value'), (3, 'Named option: -[name]'), (5, 'Named option: --[name]'), (4, 'Positional parameter: value')], default=2, help_text='Command line pattern', verbose_name='Command line format')),
        ...
        migrations.AddField(
            model_name='job',
            name='submission',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='service_jobs', to=swapper.get_model_name('wcore', 'Submission')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cmd_format', models.IntegerField(choices=[(0, '-- Not used in job command line--'), (6, 'Named parameter: [name]=value'), (2, 'Named parameter: -[name] value'), (1, 'Named parameter: --[name]=value'), (3, 'Named option: -[name]'), (5, 'Named option: --[name]'), (4, 'Positional parameter: value')], default=4, editable=False, null=True, verbose_name='Parameter Type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                #('submission', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='exit_codes', to=settings.WCORE_SUBMISSION_MODEL)),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL,
                                    related_name='service_jobs', to=swapper.get_model_name('wcore', 'Submission')),
            preserve_default=True
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            bases=(waves.wcore.models.inputs.NumberParam, 'wcore.aparam'),
            managers=[
                ('base_objects', django.db.models.manager.Manager()),
            ],
        ),
        ...
        migrations.AddField(
            model_name='submission',
            name='runner',
            field=models.ForeignKey(help_text='Service job runs adapter', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='wcore_submission_runs', to='wcore.Runner'),
        ),
        migrations.AddField(
            model_name='submission',
            name='service',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, help_text='By default access is granted to everyone, you may restrict access here.', related_name='wcore_service_restricted_services', to=settings.AUTH_USER_MODEL, verbose_name='Restricted clients'),
        ),
        migrations.AddField(
            model_name='service',
            name='runner',
            field=models.ForeignKey(help_text='Service job runs adapter', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='wcore_service_runs', to='wcore.Runner'),
        ),
        migrations.CreateModel(
