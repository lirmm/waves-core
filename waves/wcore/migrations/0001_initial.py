# -*- coding: utf-8 -*-
# Generated by Django 1.11.1 on 2017-07-24 11:29
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('restricted_client', models.ManyToManyField(blank=True, help_text='By default access is granted to everyone, you may restrict access here.', related_name='wcore_service_restricted_services', to=settings.AUTH_USER_MODEL, verbose_name='Restricted clients')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('runner', models.ForeignKey(help_text='Service job runs adapter', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='wcore_submission_runs', to='wcore.Runner')),
                ('service', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='submissions', to=settings.WCORE_SERVICE_MODEL)),
            ],
            options={
                'ordering': ('order',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('submission', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='exit_codes', to='wcore.Submission')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='from_input',
            field=models.ForeignKey(blank=True, help_text='Is valuated from an input', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='to_outputs', to='wcore.AParam'),
        ),
        migrations.AddField(
            model_name='submissionoutput',
            name='submission',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='outputs', to='wcore.Submission'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='submission',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='submission_groups', to='wcore.Submission'),
        ),
        migrations.AddField(
            model_name='job',
            name='submission',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='service_jobs', to='wcore.Submission'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='aparam',
            name='submission',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='inputs', to='wcore.Submission'),
        ),
        migrations.AddField(
            model_name='service',
            name='runner',
