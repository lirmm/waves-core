...
def schema_view(request):
    generator = schemas.openapi.SchemaGenerator(title='WAVES API v2 schema',
        description='Autogenerated API Endpoint to dispatch and retrieve jobs from distant computing infrastructure',
        urlconf='waves.api.v2.urls'
    )
