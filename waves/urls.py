...
from waves.views.jobs import JobInputView, JobOutputView, JobSubmissionView, JobView, JobListView
from waves.views.services import ServiceListView, ServiceDetailView
