# -*- coding: utf-8 -*-
# Generated by Django 1.11.1 on 2017-07-05 13:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cmd_format', models.IntegerField(choices=[(2, '-[name] value'), (1, '--[name]=value'), (3, '-[name]'), (5, '--[name]'), (4, 'Posix')], default=2, help_text='Command line pattern', verbose_name='Command line format')),
            ...
            options={
                'ordering': ['order'],
                'verbose_name': 'Simple param',
                'verbose_name_plural': 'Simple params',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('command_type', models.IntegerField(choices=[(2, '-[name] value'), (1, '--[name]=value'), (3, '-[name]'), (5, '--[name]'), (4, 'Posix')], default=4, editable=False, null=True, verbose_name='Parameter Type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('runner', models.ForeignKey(help_text='Service job runs adapter', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='waves_service_runs', to='waves.Runner')),
            ],
            options={
                'ordering': ['name'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.UUIDField(blank=True, default=uuid.uuid4, editable=False, unique=True)),
                ('api_name', models.CharField(blank=True, help_text='Api short code, must be unique', max_length=100, null=True)),
                ('availability', models.IntegerField(choices=[(0, 'Not Available'), (1, 'Available on web only'), (2, 'Available on waves:api_v2 only'), (3, 'Available on both')], default=3, verbose_name='Availability')),
        ...
        migrations.AddField(
            model_name='aparam',
            name='parent',
            field=models.ForeignKey(blank=True, help_text='Input is associated to', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='dependents_inputs', to='waves.AParam'),
        ),
        migrations.AddField(
            model_name='aparam',
