...
from waves.models.inputs import AParam, FileInput, BooleanParam, ListParam, IntegerParam, DecimalParam, \
...
class AParamAdmin(WavesModelAdmin, PolymorphicChildModelAdmin):
    ...
    def save_model(self, request, obj, form, change):
        ...
        try:
            ...
            messages.error(request, "Error occurred saving param %s" % e)
            pass
        else:
