...
from waves.admin.views import JobCancelView, JobRerunView
from waves.admin.forms import JobInputForm, JobOutputForm, JobForm
...
from waves.models.jobs import JobInput, Job, JobOutput
