...
from waves.models import Service, Submission, TextParam, BooleanParam, Job, JobInput, \
    JobOutput, \
    Runner, AdaptorInitParam
from waves.models.inputs import FileInput
from waves.models.services import ServiceRunParam
...
class TestJobWorkflowMixin(TestCase):
    ...
    def sample_runner(self, adaptor=None):
        ...
        Returns:
            ...
            :param adaptor:
        """
        from tests.adaptors.mocks import MockJobRunnerAdaptor
