...
from waves.core.api.views.base import schema_view

urlpatterns = [
    # Schema to be used with coreapi
    url(r'^schema$', schema_view),
    url(r'^', include('waves.core.api.v2.urls', namespace='v2')),
    url(r'^v1/', include('waves.core.api.v1.urls', namespace='v1')),
]
