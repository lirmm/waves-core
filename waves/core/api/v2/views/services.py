...
from waves.core.api.v2.serializers.jobs import JobSerializer
from waves.core.api.v2.serializers.services import ServiceSerializer, ServiceFormSerializer, ServiceSubmissionSerializer
from waves.core.api.views.base import WavesAuthenticatedView
...
class ServiceJobSubmissionView(MultipleFieldLookupMixin, generics.RetrieveAPIView, generics.CreateAPIView,
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            from waves.core.api.v2.serializers.jobs import JobCreateSerializer
