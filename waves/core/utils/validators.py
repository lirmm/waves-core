...
import waves.core.models.services
...
class ServiceInputValidator(object):
    ...
    def _validate_input_int(self, the_input, value):
        assert the_input.type == waves.core.adaptors.const.TYPE_INTEGER
    ...
    def _validate_input_float(self, the_input, value):
        assert the_input.type == waves.core.adaptors.const.TYPE_FLOAT
