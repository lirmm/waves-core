...
from waves.core.admin.forms.jobs import JobInputForm, JobOutputForm, JobForm
...
class JobAdmin(WavesModelAdmin):
    ...
    def suit_row_attributes(self, obj, request):
        css_class = {
            waves.core.adaptors.const.JOB_COMPLETED: 'success',
            waves.core.adaptors.const.JOB_RUNNING: 'warning',
            waves.core.adaptors.const.JOB_ERROR: 'error',
            waves.core.adaptors.const.JOB_CANCELLED: 'error',
            waves.core.adaptors.const.JOB_PREPARED: 'info',
            waves.core.adaptors.const.JOB_CREATED: 'info',
        }.get(obj.status)
        if css_class:
