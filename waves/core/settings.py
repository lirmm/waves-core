...
DEFAULTS = {
    ...
    'ADAPTORS_CLASSES': (
        'waves.adaptors.saga.shell.SshShellAdaptor',
        'waves.adaptors.saga.cluster.LocalClusterAdaptor',
        'waves.adaptors.saga.shell.SshKeyShellAdaptor',
        'waves.adaptors.saga.shell.LocalShellAdaptor',
        'waves.adaptors.saga.cluster.SshClusterAdaptor',
        'waves.adaptors.saga.cluster.SshKeyClusterAdaptor',
    ),
    'PURGE_WAIT': 86400,
    'PERMISSION_CLASSES': (),
