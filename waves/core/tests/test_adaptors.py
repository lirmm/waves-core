...
from waves.core.adaptors.cluster import LocalClusterAdaptor, SshClusterAdaptor
...
from waves.core.tests.utils import *
...
class RunnerTestCase(TestCase, TestJobWorkflowMixin):
    ...
    def testCpLocalJob(self):
        ...
        self.assertEqual(job.status, waves.core.adaptors.const.JOB_TERMINATED)
