...
class Runner(Described, ExportAbleMixin, HasAdaptorClazzMixin):
    ...
    def serializer(self):
        ...
        from waves.core.models.serializers.runners import RunnerSerializer
        return RunnerSerializer

    @property
    def runs(self):
        services_list = self.core_service_runs.all()
        submissions_list = self.core_submission_runs.all()
