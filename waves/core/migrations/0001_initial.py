    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('required', models.NullBooleanField(choices=[(None, 'Not submitted by user'), (False, 'Optional'), (True, 'Required')], default=True, help_text='Submitted and/or Required', verbose_name='Required')),
                ...
                ('parent', models.ForeignKey(blank=True, help_text='Input is associated to', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='dependents_inputs', to='core.AParam')),
                ('polymorphic_ctype', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='polymorphic_core.aparam_set+', to='contenttypes.ContentType')),
            ],
            options={
                'verbose_name': 'Input',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('enabled', models.BooleanField(blank=True, default=True, help_text='Runner is enable for job runs', verbose_name='Enabled')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('binary_file', models.ForeignKey(blank=True, help_text="If set, 'Execution parameter' param line:'command' will be ignored", null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.ServiceBinaryFile')),
                ('runner', models.ForeignKey(help_text='Service job runs configuration', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='core_submission_runs', to='core.Runner', verbose_name='Computing infrastructure')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_input', models.ForeignKey(blank=True, default=None, help_text='Is valuated from an input', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='to_outputs', to='core.AParam')),
                ('submission', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='outputs', to='core.Submission')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, help_text="Public access is granted to everyone, If status is 'Restricted' you may restrict access to specific users here.", related_name='core_service_restricted_services', to=settings.AUTH_USER_MODEL, verbose_name='Restricted clients'),
        ),
        migrations.AddField(
            model_name='service',
            name='runner',
            field=models.ForeignKey(help_text='Service job runs configuration', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='core_service_runs', to='core.Runner', verbose_name='Computing infrastructure'),
        ),
        migrations.CreateModel(
            name='SampleDepParam',
            fields=[
                ...
                ('related_to', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='related_samples', to='core.AParam')),
                ('sample', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='dependent_inputs', to='core.FileInputSample')),
                ('file_input', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sample_dependencies', to='core.FileInput')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('submission', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='submission_groups', to='core.Submission')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('submission', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='exit_codes', to='core.Submission')),
            ],
            options={
