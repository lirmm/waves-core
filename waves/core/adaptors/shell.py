...
class LocalShellAdaptor(JobAdaptor):
    ...
    _states_map = {
        saga.job.UNKNOWN: waves.core.adaptors.const.JOB_UNDEFINED,
        saga.job.NEW: waves.core.adaptors.const.JOB_QUEUED,
        saga.job.PENDING: waves.core.adaptors.const.JOB_QUEUED,
        saga.job.RUNNING: waves.core.adaptors.const.JOB_RUNNING,
        saga.job.SUSPENDED: waves.core.adaptors.const.JOB_SUSPENDED,
        saga.job.CANCELED: waves.core.adaptors.const.JOB_CANCELLED,
        saga.job.DONE: waves.core.adaptors.const.JOB_COMPLETED,
        saga.job.FAILED: waves.core.adaptors.const.JOB_ERROR,
    }
